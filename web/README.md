...
Admins see an additional Admin tab after sign-in. Use it to create cohorts, invite additional admins/coaches/participants, and assign users to cohorts without Rails console commands.
