...
class HouseholdFinanceMiaContextualMatrixTest < ActionDispatch::IntegrationTest
  ...
  def run_coach_cases(household, manager)
    cases = [
      ...
      [ "Can I give family $500 this week?", [ "$500", "Next CFO move" ] ],
      ...
      [ "If I buy a $1,800 laptop today, what exactly happens to my runway?", [ "cannot calculate the exact runway impact", "which account" ] ],
      ...
      [ "What should I do with a $1,000 bonus?", [ "extra money", "runway" ] ],
