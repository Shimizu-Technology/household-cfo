...
- `GET/POST /api/v1/document_imports`, `GET /api/v1/document_imports/:id`, `POST /api/v1/document_imports/:id/apply`, `POST /api/v1/document_imports/:id/reprocess`, `GET /api/v1/document_imports/:id/source_url`, `DELETE /api/v1/document_imports/:id/source` — private S3 document upload, extraction, review, and apply workflow. Multi-page PDFs are extracted in complete four-page batches; structured statement files and review queues support up to 500 transaction rows without silent truncation.
