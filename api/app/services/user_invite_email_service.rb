...
class UserInviteEmailService
  BRAND_NAME = "Household CFO Method powered by VERA".freeze
      ...
      response = Resend::Emails.send(
        {
          from: from_email,
          to: user.email,
          subject: "You're invited to Household CFO Method",
      ...
      <<~HTML
        ...
        <html>
          <head>
            ...
            <title>Household CFO Method Invitation</title>
          </head>
              ...
              <tr>
                <td align="center" style="padding:40px 16px;">
                  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background-color:#fffdf8;border:1px solid #e2d9cb;border-radius:18px;overflow:hidden;box-shadow:0 18px 54px rgba(47,38,28,0.10);">
                    <tr><td style="height:5px;background-color:#7b4a58;font-size:0;line-height:0;">&nbsp;</td></tr>
                    <tr>
                      <td style="padding:34px 34px 0 34px;text-align:center;">
                        <p style="margin:0 0 10px 0;color:#7b4a58;font-size:11px;letter-spacing:0.18em;text-transform:uppercase;font-weight:800;">Cohort invitation</p>
                        <h1 style="margin:0;color:#1f2421;font-family:Georgia,'Times New Roman',serif;font-size:30px;line-height:1.08;font-weight:700;">You're invited to Household CFO Method</h1>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="padding:22px 34px 0 34px;">
                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#f1e2e3;border:1px solid #e4cfd1;border-radius:14px;">
                          <tr>
                    ...
                    <tr>
                      <td align="center" style="padding:26px 34px 0 34px;">
                        <table role="presentation" cellspacing="0" cellpadding="0">
                          <tr>
                            <td style="border-radius:999px;background-color:#7b4a58;">
                              <a href="#{button_href}" target="_blank" style="display:inline-block;padding:14px 30px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:800;">Open Household CFO Method</a>
                            </td>
                          </tr>
                        </table>
                      </td>
                    ...
                    <tr>
                      <td style="padding:18px 34px 0 34px;text-align:center;">
                        ...
                        <p style="margin:0;color:#7b4a58;font-size:12px;word-break:break-all;">#{display_link}</p>
                      </td>
                    </tr>
                    <tr>
